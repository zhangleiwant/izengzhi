    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth', models.DateField(blank=True, null=True, verbose_name='用户生日')),
                ('gender', models.CharField(choices=[('male', '男'), ('femal', '女')], default='female', max_length=6, verbose_name='用户性别')),
